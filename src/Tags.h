...
class Tags {
  ...
  */
public:
  static const int nResult = -2; // during a conversion, certain character
                                 // strings should only be converted once
...
public:
  static std::string SubStr(std::string &s, int n);
  ...
  static int binary_search_utf8(const std::vector<std::string> &list,
  ...
  static void create_tag(int i, int j, int index,
                         std::vector<Tags::Entity> &tokens,
                         std::vector<std::array<int, 2>> &parameter_list);
  static void
  add_parameter_block(int i, std::vector<Tags::Entity> &tokens,
                      std::vector<std::array<int, 2>> &parameter_list);
  static void add_argument(int i, std::vector<Tags::Entity> &tokens,
                           const std::array<int, 2> argument);

  static bool check_tag(int i, const std::vector<Tags::Entity> &tokens,
                        int &index,
                        std::vector<std::array<int, 2>> &parameter_list,
                        int &j);
  static bool check_arg(int i, const std::vector<Tags::Entity> &tokens,
  ...
  GetParameters(Tags::Entity tag);
  static std::vector<std::vector<std::string>> GetArguments(Tags::Entity tag);
  static void
  display_parameters(std::vector<std::vector<std::vector<std::string>>> p);
  static void
  display_arguments(std::vector<std::vector<std::string>> arguments);
...
private:
  ...
  ToStringArrayList(std::vector<Tags::Entity> le, std::vector<int> index);
  ...
  static std::string StringifyMATag(Tags::Entity e);
